  ...
  def add_categories
    ["Ruby", "Rails", "WSL", "Linux", "Hotwire", "DevOps", "Marketing", "Frontend"].each do |name|
      ...
      category.category_image.attach(
        ...
        io: Rails.root.join("lib/tasks/images/category#{image_id}.jpg").open,
  ...
  def add_authors
    5.times do
      ...
      author.avatar_image.attach(
        # io: File.open(Rails.root.join("lib/tasks/images/full-hd/0#{image_id}.jpg")),
        io: Rails.root.join("lib/tasks/images/avatar-#{image_id}.png").open,
  ...
  def add_articles
    50.times do
      ...
      article.cover_image.attach(
        # io: File.open(Rails.root.join("lib/tasks/images/full-hd/0#{image_id}.jpg")),
        io: Rails.root.join("lib/tasks/images/full-hd/0#{image_id}.jpg").open,
